"""semirestful_users_project URL Configuration
...
urlpatterns = [
    url(r'^', include('apps.restful_users_app.urls')) # And now we use the include function to pull in our first_app.urls...
]
